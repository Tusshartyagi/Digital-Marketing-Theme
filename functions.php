...
function korvage_style()
{
    ...
    wp_enqueue_script( 'viewport-script', get_stylesheet_directory_uri() . '/asset/js/viewport.js', array(), '1.0', true );
...
function theme_widgets_init() {
    register_sidebar( array(
        'name' => __( 'Sidebar 1', 'korvage' ),
        'id' => 'sidebar1',
        'description' => __( 'Widgets in this area will be shown in the sidebar.', 'korvage' ),
