...
/**
 * Template Name: IT Software Consultancy Page
 */
get_header();
?>
<style>
  ...
  .tab-content {
    ...
    width: 90%;
    border-radius: 20px;
    transition: left 1s ease; /* Add transition property */
}

.tab-content.active {
    display: block!important;
    left: 0; /* Adjust left position for active tab content */
}
	.tab-content p{
        ...
        <div class="row" style="align-items:center">
            <div class="col-xl-5">
                <div class="breadcumb" style="text-align:left">
                    ...
                    <button class="my-2 py-2"><a href="<?php echo esc_html(get_field('url')); ?>">Consult Our
                            Experts</a></button>
                </div>
            </div>
...
<section class="services-area pt-50 pb-50">
    <div class="container pb-5">
      ...
      ?>
        <h2 class="pb-3 app-title" style="line-height: 1.3em;color:#202020;font-size:36px">
            <?php echo esc_html($web_title); ?>
        </h2>
        <p style="color:#202020; font-size:18px" class="app-description">
            <?php echo esc_html($web_description); ?>
        </p>
    </div>
               ...
               $args = array(
                  ...
                  'tax_query' => array(
                     array(
                        ...
                        'field' => 'name',
                        'terms' => 'IT Software Consultancy' // Term name
                     )
                  )
               );
...
<section class="services-area pt-50 pb-50">
    <div class="container pb-5 px-lg-1">
      ...
      ?>
        <h2 class="py-3 w-lg-75" style="line-height: 1.3em;color:#202020;font-size:36px">
            <?php echo esc_html($process_title); ?>
        </h2>
        <p class="w-md-100 w-lg-75 align-content" style="color:#202020; font-size:18px">
            <?php echo esc_html($process_description); ?>
        </p>
    </div>
    <div class="toggle-container mx-auto">
        <div class="toggle-option active" id="software-based">
            Software Based Consulting
        </div>
    ...
    <div class="toggle-content mx-auto active mt-5" id="software-content">
        <div class="desktop-responsive" style="width: 84%;background-color: #f0f0f0;border-radius:20px">
            ...
            $args = array(
               ...
               'tax_query' => array(
                  array(
                     'taxonomy' => 'services-box', // Taxonomy name
                     'field' => 'name',
                     'terms' => 'Software Based Consulting', // Term name
                  )
               )
            );
            $services_query = new WP_Query($args);
            ...
            if ($services_query->have_posts()) :
               ...
               while ($services_query->have_posts()) : $services_query->the_post();
                  $counter++;
            ?>
                <div class="card-row single-card m-1" style="background-color:white;width:31%">
                    <div class="border-0 text-left mb-2">
                        <div class="card-body choose-card">
                            <div class="d-flex align-items-center">
                                <?php
                              if (has_post_thumbnail()) {
                                 the_post_thumbnail('medium', ['class' => 'img mb-1 pr-2 mx-auto']);
                              }
                              ?>
                            </div>
                            <div class="content">
        ...
        <div class="mobile-responsive py-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="testimonials owl-carousel">
    ...
    <div class="toggle-content mx-auto mt-5" id="solution-content">
        <div class="desktop-responsive" style="width: 80%;background-color: #f0f0f0;border-radius:20px">
            <div class="card-container row my-3" style="justify-content: space-evenly;">
                <?php
         // Query to fetch posts from Services custom post type
         $args = array(
            ...
            'tax_query' => array(
               array(
                  'taxonomy' => 'services-box', // Taxonomy name
                  'field' => 'name',
                  'terms' => 'Solution Based Consulting', // Term name
               )
            )
         );
         $services_query = new WP_Query($args);
...
<section class="services-area pt-50 pb-50">
    <div class="container pb-5 px-lg-5 text-center mx-auto">
      ...
      ?>
        <h2 class="py-3 w-lg-75 mx-auto px-lg-5" style="line-height: 1.3em;color:#202020;font-size:36px">
...
<section class="services-area pt-50 pb-50">
    <div class="container pb-3 px-1">
      ...
      ?>
        <h2 class="pb-3 app-title" style="line-height: 1.3em;color:#202020;font-size:32px">
            <?php echo esc_html($choose_us_title); ?>
        </h2>
        <p class="app-description" style="color:#202020; font-size:18px">
            <?php echo esc_html($choose_us_description); ?>
        </p>
    </div>
         ...
         $args = array(
            ...
            'tax_query' => array(
               array(
                  'taxonomy' => 'services-box', // Taxonomy name
                  'field' => 'name',
                  'terms' => 'IT Consultancy Choose Us', // Term name
               )
            )
         );
         $services_query = new WP_Query($args);
...
<section class="services-area pt-50 pb-50">
    <div class="container pb-3 px-1">
      ...
      ?>
        <h2 class="pb-3 w-lg-75 mx-auto" style="line-height: 1.3em;color:#202020;font-size:32px;text-align:center">
            <?php echo esc_html($digital_title); ?>
        </h2>
    </div>
<div class="container-fluid pb-0 px-lg-5 desktop-responsive">
    <div class="container">
        <div class="row">
            <div class="col-5">
                <div class="vertical-tabs">
                    ...
                    $args = array(
                        ...
                        'tax_query' => array(
                            array(
                                'taxonomy' => 'services-box', // Taxonomy name
                                'field' => 'name',
                                'terms' => 'Software Consultancy', // Term name
                            )
                        )
                    );
                    $services_query = new WP_Query($args);
                    ...
                    ?>
                            <div class="tab <?php echo $active_class; ?>" onclick="openTab(event, 'content<?php echo $counter; ?>', <?php echo ($counter - 1); ?>)">
                                <?php the_title(); ?><span class="arrow-icon">&#9658;</span>
                            </div>
                    <?php
                        endwhile;
                        wp_reset_postdata();
            ...
            <div class="col-7">
                <div class="nav-dots mx-auto mb-4">
                    <?php
                    if ($services_query->have_posts()) :
                        $counter = 0;
                        while ($services_query->have_posts()) : $services_query->the_post();
                            $counter++;
                    ?>
                            <span class="nav-dot<?php echo ($counter == 1) ? ' active-dot' : ''; ?>" onclick="showSlide(<?php echo ($counter - 1); ?>, 'content<?php echo $counter; ?>')"></span>
                    <?php
                        endwhile;
                        wp_reset_postdata();
                    endif;
                ...
                if ($services_query->have_posts()) :
                    ...
                    while ($services_query->have_posts()) : $services_query->the_post();
                        $counter++;
                ?>
                        <div id="content<?php echo $counter; ?>" class="mx-auto tab-content<?php echo ($counter == 1) ? ' active' : ''; ?>">
                            <div class="card-row single-card m-1 p-5" style="background-color:white;width:100%">
                    <div class="border-0 text-left mb-2">
                        <div class="card-body choose-card">
                            <div class="d-flex align-items-center">
                                <?php
                           ...
                           ?>
                            ...
                            <div class="content py-3" style="text-align:center!important">
                                <h3 class="mb-1">
                                    <?php the_title(); ?>
                                </h3>
                                    <?php the_content(); ?>
    ...
    <div class="container mobile-responsive py-5">
        <div class="row">
            <div class="col-md-12">
                <div class="testimonials owl-carousel">
                    <?php
               ...
               if ($services_query->have_posts()) :
                  while ($services_query->have_posts()) : $services_query->the_post();
               ?>
                    <div class="service" style="align-items: center;display: flex;flex-direction: column;padding: 20px;border: 2px solid rgba(0, 0, 0, 1);border-radius: 20px;">
                        <?php
                        if (has_post_thumbnail()) {
                           the_post_thumbnail('medium', ['class' => 'w-25 mb-3']);
                        }
                        ?>
                        <div class="single-service-content" style="text-align:center">
                            <h5>
                                <?php the_title(); ?>
                            </h5>
                            <?php the_content(); ?>
...
<section class="services-area pt-50 pb-50">
    <div class="container">
        <div class="row" style="align-items:center">
                            ...
                            <div class="box-wrapper">
                                <div class="item wow fadeInUpBig animated animated" data-number="12"
                                    ...
                                    <div class="content-wrapper">
                                        ...
                                        <h6 id="number1" class="number">
                                            <?php echo esc_html(get_field('counter')['title']); ?>
                                        </h6>
                                        <h2><span class="counter">
                                                <?php echo number_format(get_field('counter')['name']); ?>
                                            </span>+</h2>
                                    </div>
                                </div>
                                <div class="item wow fadeInUpBig animated animated" data-number="12"
                                    style="visibility: visible; margin-top: -20px; border-radius: 8px;">
                                    <div class="content-wrapper">
                                        <img src="<?php echo esc_url(get_field('counter_2')['image']); ?>">
                                        <h6 id="number1" class="number">
                                            <?php echo esc_html(get_field('counter_2')['title']); ?>
                                        </h6>
                                        <h2><span class="counter">
                                                <?php echo number_format(get_field('counter_2')['name']); ?>
                                            </span>+</h2>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box-wrapper-1">
                                <div class="item wow fadeInUpBig animated animated" data-number="12"
                                    ...
                                    <div class="content-wrapper">
                                        ...
                                        <h6 id="number1" class="number">
                                            <?php echo esc_html(get_field('counter_1')['title']); ?>
                                        </h6>
                                        <h2><span class="counter">
                                                <?php echo number_format(get_field('counter_1')['name']); ?>
                                            </span>+</h2>
                                    </div>
                                </div>
                                <div class="item wow fadeInUpBig animated animated" data-number="12"
                                    ...
                                    <div class="content-wrapper">
                                        ...
                                        <h6 id="number1" class="number">
                                            <?php echo esc_html(get_field('counter_3')['title']); ?>
                                        </h6>
                                        <h2><span class="counter">
                                                <?php echo number_format(get_field('counter_3')['name']); ?>
                                            </span>+</h2>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-xl-6 pl-lg-5" style="margin-top:12px">
...
<section class="testimonial pt-50 pb-50">
    <div class="container-fluid">
        <div class="px-5 text-center mx-auto">
         ...
         ?>
            <h2 class="pb-3 w-lg-75 mx-auto px-lg-5" style="line-height: 1.3em;color:#202020;">
                <?php echo esc_html($testimonial_title); ?>
            </h2>
            <p class="w-lg-50 mx-auto px-lg-5"
                style="line-height: 1.3em;color:#202020;font-size:18px;text-align:center">
                <?php echo esc_html($testimonial_descriptions); ?>
            </p>
        </div>
        <div id="testimonial4"
            ...
            $args = array(
               ...
               'tax_query' => array(
                  array(
                     ...
                     'field' => 'name',
                     'terms' => 'IT Software Consulting', // Term name
                  )
               )
            );
                    ...
                    <div class="testimonial4_slide">
                        ...
                        <div class="row img">
                            <img src="<?php the_post_thumbnail_url('thumbnail'); ?>"
                                class="img-circle img-responsive p-1" />
                            <span class="px-3">
                                <h4>
                                    <?php the_title(); ?>
                                </h4>
...
function showSlide(n) {
    var i;
    var slides = document.getElementsByClassName("tab-content");
    ...
    slides[n].classList.add("active"); // Add active class to the target slide
