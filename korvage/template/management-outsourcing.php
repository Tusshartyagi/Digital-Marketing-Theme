            ...
            <div class="container" style="z-index: 1;position: relative;">
             	<div class="row mobile-view" style="column-gap:20px; row-gap:50px;flex-wrap:nowrap">
             		<div class="col-lg-4 col-md-12 d-flex pb-3" style="text-align:center;background: #ffffff5e;justify-content: center;align-items: center;border-radius: 25px;border: 1px solid rgba(255, 255, 255, 1);">
             				  <div class="data mx-2 p-5" style="color:white;"><h2 style="color:white;font-size: 49px!Important;text-align: center!Important;"><span class="counter"><?php echo esc_html(get_field('process_box_1')['percentage']); ?></span>-<span class="counter"><?php echo esc_html(get_field('process_box_1')['percentage_1']); ?></span>%</h2>
                   ...
                   <div class="col-lg-4 col-md-12 d-flex pb-3" style="text-align:center;height: 290px;width: 100%;background: #ffffff5e;justify-content: center;align-items: center;border-radius: 25px;border: 1px solid rgba(255, 255, 255, 1);">
             				  <div class="data mx-2 p-5"style="color:white;"><h2 style="color:white;font-size: 49px!Important;text-align: center!Important;"><span class="counter"><?php echo esc_html(get_field('process_box_2')['percentage']); ?></span>%</h2>
                              <h4 style="color:white;"><?php echo esc_html(get_field('process_box_2')['title']); ?></h4>
							</div>
                   </div>
                   <div class="col-lg-4 col-md-12 d-flex pb-3" style="text-align:center;height: 290px;width: 100%;background: #ffffff5e;justify-content: center;align-items: center;border-radius: 25px;border: 1px solid rgba(255, 255, 255, 1);">
             				  <div class="data mx-2 p-5" style="color:white;"><h2 style="color:white;font-size: 49px!Important;text-align: center!Important;"><span class="counter"><?php echo esc_html(get_field('process_box_3')['percentage']); ?></span>%</h2>
