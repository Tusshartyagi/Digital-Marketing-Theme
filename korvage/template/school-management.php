...
<section class="services-area pt-50 pb-50">
   ...
   <div class="services-area px-2 pt-5" id="services">
      <div class="px-5 w-lg-75 mx-auto">
    ...
    <div class="container">
        <div id="testimonial-carousel" class="carousel slide testimonial-carousel_indicators testimonial-carousel_control_button thumb_scroll_x swipe_x" data-ride="carousel" data-pause="hover" data-interval="false" data-duration="2000">
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <div class="carousel-category mx-auto" style="width: 100%;padding: 10px 80px;display: flex;flex-direction: column;align-items: center;">
                     	...
                     	<h2 class="mt-4" style="text-align:center;width: max-content;background-color:#145CAA66;padding: 10px 80px;border-radius: 50px;"><?php echo esc_html(get_field('process')['name']) ?></h2>
                    </div>
            ...
            <a class="carousel-control-prev" role="button" data-slide="prev">
                <span class="carousel-control-prev-icon" style="top:200px; left:149%; position:absolute; background-color:rgba(20, 92, 170, 0.4)"></span>
            </a>
            <a class="carousel-control-next" role="button" data-slide="next">
                <span class="carousel-control-next-icon" style="top:200px;right:100%; position:absolute; background-color:rgba(20, 92, 170, 0.4)"></span>
            </a>
        </div>
    </div>
</section>
