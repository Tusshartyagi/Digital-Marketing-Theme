...
<section class="services-area pt-50 pb-50">
   ...
   <!-- HTML -->
   <div class="row container-fluid mx-lg-auto mx-md-0" style="height: 600px; position: relative;">
      ...
      <div class="col-lg-6 p-0 col-md-12">
         ...
         <div class="circle">
            ...
            <div class="container pl-3 mx-0 w-25 mx-auto" style="margin-top: -58%;margin-left: 26%!Important;">
