      ...
      <div class="row pt-md-5" style="align-items:left;">
         <div class="col-xl-12 px-0">
            <div class="breadcumb px-0 mx-auto" style="color:#fff;text-align:center!Important;">
               <h1 class="py-2" style="text-align:center;color:white!important">Search Results for: "<?php echo esc_html(get_search_query()); ?>"</h1>
      ...
      <div class="row pt-md-5" style="align-items:left;">
         <div class="col-xl-12 px-0">
            <div class="breadcumb px-0" style="color:#fff;text-align:center!Important;">
               <h1 class="pb-2" style="text-align:center;color:white!important">Search Results for: "<?php echo esc_html(get_search_query()); ?>"</h1>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-9 col-md-12">
                <div class="row pt-4">
                    <!-- Loop through the search results and display them in cards -->
                    <?php if (have_posts()) : ?>
                        <?php while (have_posts()) : the_post(); ?>
                            <div class="col-lg-6 card-space col-md-12 p-0 py-md-3">
                                <!-- Display the search result cards here -->
                                <div class="blog-card">
