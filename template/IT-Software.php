...
<section class="services-area pt-50 pb-50">
    ...
    <div class="toggle-content mx-auto active mt-5" id="software-content">
        ...
        <div class="mobile-responsive py-4 w-100">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="testimonials owl-carousel">
...
<section class="services-area pt-50 pb-50">
    ...
    <section class="services-area px-2 py-2 px-0 px-lg-2" id="services">
...
<hr>
<section class="services-area pt-50 pb-50">
    <div class="container pb-3 px-4 px-lg-2">
        <?php
...
<section class="testimonial pt-50 pb-50">
    <div class="container-fluid">
        <div class="px-lg-5 text-center mx-auto">
            ...
            <p class="w-lg-50 mx-auto px-lg-5" style="line-height: 1.3em;color:#202020;font-size:18px;text-align:center">
