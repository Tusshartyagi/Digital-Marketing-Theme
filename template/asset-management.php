...
/**
 * Template Name: Asset Management Page
 */
get_header();
?>
<style>
               ...
               $args = array(
                  ...
                  'tax_query' => array(
                     array(
                        ...
                        'field' => 'name',
                        'terms' => 'Asset Management' // Term name
                     )
                  )
               );
...
<section class="services-area pt-50 pb-50">
   ...
   <section class="services-area px-lg-2 pb-2" id="services">
         ...
         $args = array(
            ...
            'tax_query' => array(
               array(
                  'taxonomy' => 'services-box', // Taxonomy name
                  'field' => 'name',
                  'terms' => 'Asset Choose Us', // Term name
               )
            )
         );
         $services_query = new WP_Query($args);
...
<section class="services-area pt-50 pb-50">
   <div class="container pb-5 px-lg-5 text-center mx-auto">
      ...
      <p class="w-100 w-lg-75 mx-auto" style="color:#202020; font-size:18px;text-align:left"><?php echo esc_html($process_description); ?></p>
   </div>
   <!-- HTML -->
   <section class="services-area px-lg-3" id="services">
      <div class="container-fluid px-0 px-lg-2">
         <div class="px-lg-5">
            <div class="global-process box-300 my-3 mx-md-auto ml-lg-auto" style="margin-right:0%;border-radius:5px; background:<?php echo esc_html(get_field('process')['color']) ?>;">
               <h5 class=""><?php echo esc_html(get_field('process')['title']); ?><span class="pl-3"><img src="<?php echo esc_url(get_field('process')['image']) ?>" ; style="width:40px" /></span></h5>
            </div>
            <div class="global-process box-300 my-3 mx-md-auto ml-lg-auto" style="margin-right:12%;border-radius:5px; background:<?php echo esc_html(get_field('process_1')['color']) ?>;">
               <h5 class=""><?php echo esc_html(get_field('process_1')['title']); ?><span class="pl-3"><img src="<?php echo esc_url(get_field('process_1')['image']) ?>" ; style="width:40px" /></span></h5>
            </div>
            <div class="global-process box-300 my-3 mx-md-auto ml-lg-auto" style="margin-right:24%;border-radius:5px; background:<?php echo esc_html(get_field('process_2')['color']) ?>;">
               <h5 class=""><?php echo esc_html(get_field('process_2')['title']); ?><span class="pl-3"><img src="<?php echo esc_url(get_field('process_2')['image']) ?>" ; style="width:40px" /></span></h5>
            </div>
            <div class="global-process box-300 my-3 mx-md-auto ml-lg-auto" style="margin-right:36%;border-radius:5px; background:<?php echo esc_html(get_field('process_3')['color']) ?>;">
               <h5 class=""><?php echo esc_html(get_field('process_3')['title']); ?><span class="pl-3"><img src="<?php echo esc_url(get_field('process_3')['image']) ?>" ; style="width:40px" /></span></h5>
            </div>
            <div class="global-process box-300 my-3 mx-md-auto ml-lg-auto" style="margin-right:48%;border-radius:5px; background:<?php echo esc_html(get_field('process_4')['color']) ?>;">
               <h5 class=""><?php echo esc_html(get_field('process_4')['title']); ?><span class="pl-3"><img src="<?php echo esc_url(get_field('process_4')['image']) ?>" ; style="width:40px" /></span></h5>
            </div>
            <div class="global-process box-300 my-3 mx-md-auto ml-lg-auto" style="margin-right:60%;border-radius:5px; background:<?php echo esc_html(get_field('process_5')['color']) ?>;">
               <h5 class=""><?php echo esc_html(get_field('process_5')['title']); ?><span class="pl-3"><img src="<?php echo esc_url(get_field('process_5')['image']) ?>" ; style="width:40px" /></span></h5>
            </div>
            <div class="global-process box-300 my-3 mx-md-auto ml-lg-auto" style="margin-right:72%;border-radius:5px; background:<?php echo esc_html(get_field('process_6')['color']) ?>;">
               <h5 class=""><?php echo esc_html(get_field('process_6')['title']); ?><span class="pl-3"><img src="<?php echo esc_url(get_field('process_6')['image']) ?>" ; style="width:40px" /></span></h5>
            </div>
         </div>
      </div>
   </section>
...
<section class="services-area pt-50 pb-50">
   <div class="container pb-3">
      ...
      $digital_description = get_field('digital_description');
      ?>
      <h2 class="py-3 app-title" style="line-height: 1.3em;color:#202020;font-size:32px"><?php echo esc_html($digital_title); ?></h2>
      <p class="app-description" style="color:#202020; font-size:18px"><?php echo esc_html($digital_description); ?></p>
   </div>
   <div class="container my-3 px-0 desktop-responsive" style="border:1px solid black">
      <div class="row">
         <div class="col-md-12 p-0">
            <ul class="nav nav-pills flex-row m-0 justify-content-center" id="myTab" role="tablist">
               <li class="nav-item w-25">
                  <a class="nav-link active" id="home-tab" data-toggle="tab" href="#asset" role="tab" aria-controls="home" aria-selected="true">
                     <h5 style="text-align:center">Asset Monitoring</h5>
                  </a>
               </li>
               <li class="nav-item w-25">
                  <a class="nav-link" id="profile-tab" data-toggle="tab" href="#configuration" role="tab" aria-controls="profile" aria-selected="false">
                     <h5 style="text-align:center">Configuration</h5>
                  </a>
               </li>
               <li class="nav-item w-25">
                  <a class="nav-link" id="contact-tab" data-toggle="tab" href="#usability" role="tab" aria-controls="contact" aria-selected="false">
                     <h5 style="text-align:center">Usability</h5>
                  </a>
               </li>
               <li class="nav-item w-25">
                  <a class="nav-link" id="contact-tab" data-toggle="tab" href="#security" role="tab" aria-controls="contact" aria-selected="false">
                     ...
                     <div class="card-container row">
                        ...
                        $args = array(
                           ...
                           'tax_query' => array(
                              array(
                                 'taxonomy' => 'services-box', // Taxonomy name
                                 'field' => 'name',
                                 'terms' => 'Asset Monitoring', // Term name
                              )
                           )
                        );
                        $services_query = new WP_Query($args);
                        ...
                        if ($services_query->have_posts()) :
                           ...
                           while ($services_query->have_posts()) : $services_query->the_post();
                              $counter++;
                        ?>
                              <div class="card-row m-3" style="border:1px solid black;border-radius:5px">
                                 <div class="text-left mb-2">
                                    <div class="card-body">
                                       <div class="d-flex align-items-center">
                                          <?php
                                          if (has_post_thumbnail()) {
                                             the_post_thumbnail('medium', ['class' => 'img mb-1 pr-2 mx-auto w-25']);
                                          }
                                          ?>
                                       </div>
                                       <div class="content">
                                          <h5 class="mb-1" style="text-align:center"><?php the_title(); ?></h5>
                                          <div style="text-align:center;font-weight:500"><?php the_content(); ?></div>
                                       </div>
                                    </div>
                                 </div>
                              </div>
      ...
      <div class="container-fluid">
         <div id="testimonial-carousel" class="carousel slide testimonial-carousel_indicators testimonial-carousel_control_button thumb_scroll_x swipe_x" data-ride="carousel" data-pause="hover" data-interval="false" data-duration="2000">
            <div class="carousel-inner" role="listbox">
               <?php
               // Query categories
               $categories = array('Asset Monitoring', 'Configuration', 'Usability', 'Security');

               $first_category = true; // Flag to track the first category

               foreach ($categories as $category) :
                  // Query testimonials for the current category
                  $args = array(
                     'post_type' => 'services',
                     'posts_per_page' => -1,
                     'order' => 'ASC',
               ...
               ?>
                     <div class="carousel-item <?php echo $first_category ? 'active' : ''; ?>">
                        <div class="carousel-category mx-auto" style="width: max-content;background-color:#145CAA66;padding: 10px 20px;border-radius: 50px;">
                                       ...
                                       <div class="text-left mb-2">
                                          <div class="card-body">
                                             <div class="d-flex align-items-center">
                                                <?php
                                                if (has_post_thumbnail()) {
                                                   the_post_thumbnail('medium', ['class' => 'img mb-1 pr-2 mx-auto w-50']);
                                                }
                                                ?>
                                             </div>
                                             <div class="content">
               ...
               <?php
                     $first_category = false; // Set flag to false after first category
                  endif;
               endforeach;
               ?>
            </div>
            <a class="carousel-control-prev" role="button" data-slide="prev">
               <span class="carousel-control-prev-icon" style="top:70px;left:50%; position:absolute; width:40px; height:40px"></span>
            </a>
            <a class="carousel-control-next" role="button" data-slide="next">
               <span class="carousel-control-next-icon" style="top:68px;right:46%; position:absolute; width:40px; height:40px"></span>
            </a>
         </div>
      </div>
   </section>
...
<section class="services-area pt-50 pb-50">
   <div class="container pb-5 px-lg-5 text-center mx-auto">
      ...
      ?>
      <h2 class="py-3 w-lg-75 mx-auto px-lg-5" style="line-height: 1.3em;color:#202020;"><?php echo esc_html($brand_title); ?></h2>
   </div>
