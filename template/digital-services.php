...
<section class="services-area pt-50 pb-50">
   ...
   <!-- HTML -->
   <div class="container_2 mx-auto my-lg-5 my-4">
      <div class="square">
            ...
            <div class="row">
               <div class="col">
                  <div class="row">
                     ...
                     <div class="col">
                        <div class="package-amount text-right">$299</div>
                     </div>
                  </div>
               </div>
            </div>
                        ...
                        $args = array(
                           ...
                           'tax_query' => array(
                              array(
                                 ...
                                 'field' => 'name',
                                 'terms' => 'Digital Packages', // Term name
                              )
                           )
                        );
         ...
         <div class="package-box">
            <div class="row">
               <div class="col">
                  <div class="row">
                     <div class="col">
                        <div class="package-name">Corporate</div>
                     </div>
                     <div class="col">
      ...
      <table class="w-full">
         <thead>
            <tr>
               ...
               <th class="px-4 py-5 border-bottom text-center">
                  <h4>Corporate</h4><a href="<?php echo esc_html(get_field('url_3')); ?>" class="mx-2 btn btn-transparent border text-primary border-primary px-4 py-1">Get Started</a>
               </th>
               <th class="px-4 py-5 border-bottom text-center">
                  <h4>Professional</h4><a href="<?php echo esc_html(get_field('url_4')); ?>" class="mx-2 btn btn-transparent border text-primary border-primary px-4 py-1">Get Started</a>
               </th>
            </tr>
         </thead>
         <tbody>
