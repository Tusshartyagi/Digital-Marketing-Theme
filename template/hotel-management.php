...
/**
 * Template Name: Hotel Management Page
 */
get_header();
?>
               ...
               $args = array(
                  ...
                  'tax_query' => array(
                     array(
                        ...
                        'field' => 'name',
                        'terms' => 'Hotel Management' // Term name
                     )
                  )
               );
...
<hr>
<section class="services-area pt-50 pb-50">
   <div class="container pb-lg-5 px-lg-1 px-3 text-center">
      <?php
      $process_title = get_field('dev_process_title');
      $process_description = get_field('dev_process_description');
      ?>
      <h2 class="py-3 app-title" style="line-height: 1.3em;color:#202020;font-size:36px;text-align:left"><?php echo esc_html($process_title); ?></h2>
      <p class="w-md-100 app-description" style="color:#202020; font-size:18px;"><?php echo esc_html($process_description); ?></p>
   </div>
...
<section class="services-area pt-50 pb-50">
   ...
   <div class="container px-0">
      <div class="row">
         <div class="col-md-12">
            <div class="integration owl-carousel">
               <?php
               // Query to fetch posts from Services custom post type
               $args = array(
                  'post_type' => 'industries',
               ...
               ?>
                        <?php
                        if (has_post_thumbnail()) {
                           the_post_thumbnail('medium', ['class' => 'image-size img-fluid mb-3']);
                        }
                        ?>
               <?php
                  endwhile;
         ...
         $args = array(
            ...
            'tax_query' => array(
               array(
                  'taxonomy' => 'services-box', // Taxonomy name
                  'field' => 'name',
                  'terms' => 'Hotel Choose Us', // Term name
               )
            )
         );
         $services_query = new WP_Query($args);
