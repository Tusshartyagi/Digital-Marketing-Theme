...
/**
 * Template Name:  HR Solution Page
 */
get_header();
?>
<style>
...
<section class="services-area pt-50 pb-50">
   ...
   <section class="services-area px-lg-2 py-2 px-0" id="services">
               ...
               $args = array(
                  ...
                  'tax_query' => array(
                     array(
                        ...
                        'field' => 'name',
                        'terms' => 'HR Consultancy', // Term name
                     )
                  )
               );
