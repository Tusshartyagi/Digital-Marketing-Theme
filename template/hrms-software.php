...
<hr>
<section class="services-area pt-50 pb-50">
   <div class="container pb-lg-5 pb-2 px-lg-1 px-0 text-center">
      <?php
   ...
   <div class="row p-0">
      <div class="col-lg-6 col-md-12 px-0 wrong-points">
         ...
         <h4 style="display: flex;align-items: center;" class="px-lg-5 px-2"><img src="<?php echo get_stylesheet_directory_uri() ?>/asset/img/crossed-1.png" style="width: 25px;"><span class="px-2"><?php echo esc_html(get_field('negative')['text_1']); ?></span></h4>
         <h4 style="display: flex;align-items: center;" class="px-lg-5 px-2 pt-4"><img src="<?php echo get_stylesheet_directory_uri() ?>/asset/img/crossed-1.png" style="width: 25px;"><span class="px-2"><?php echo esc_html(get_field('negative')['text_2']); ?></span></h4>
         <h4 style="display: flex;align-items: center;" class="px-lg-5 px-2 pt-4"><img src="<?php echo get_stylesheet_directory_uri() ?>/asset/img/crossed-1.png" style="width: 25px;"><span class="px-2"><?php echo esc_html(get_field('negative')['text_3']); ?></span></h4>
         <h4 style="display: flex;align-items: center;" class="px-lg-5 px-2 pt-4"><img src="<?php echo get_stylesheet_directory_uri() ?>/asset/img/crossed-1.png" style="width: 25px;"><span class="px-2"><?php echo esc_html(get_field('negative')['text_4']); ?></span></h4>
         <h4 style="display: flex;align-items: center;" class="px-lg-5 px-2 pt-4"><img src="<?php echo get_stylesheet_directory_uri() ?>/asset/img/crossed-1.png" style="width: 25px;"><span class="px-2"><?php echo esc_html(get_field('negative')['text_5']); ?></span></h4>
         <h4 style="display: flex;align-items: center;" class="px-lg-5 px-2 pt-4"><img src="<?php echo get_stylesheet_directory_uri() ?>/asset/img/crossed-1.png" style="width: 25px;"><span class="px-2"><?php echo esc_html(get_field('negative')['text_6']); ?></span></h4>
         </div>
      </div>
      <div class="col-lg-6 col-md-12 px-0 correct-points">
         ...
         <div class="p-lg-5 py-3">
         <h4 style="display: flex;align-items: center;" class="px-lg-5 px-2"><img src="<?php echo get_stylesheet_directory_uri() ?>/asset/img/check-mark-3.png" style="width: 25px;"><span class="px-2"><?php echo esc_html(get_field('positive')['text_1']); ?></span></h4>
         <h4 style="display: flex;align-items: center;" class="px-lg-5 px-2 pt-4"><img src="<?php echo get_stylesheet_directory_uri() ?>/asset/img/check-mark-3.png" style="width: 25px;"><span class="px-2"><?php echo esc_html(get_field('positive')['text_2']); ?></span></h4>
         <h4 style="display: flex;align-items: center;" class="px-lg-5 px-2 pt-4"><img src="<?php echo get_stylesheet_directory_uri() ?>/asset/img/check-mark-3.png" style="width: 25px;"><span class="px-2"><?php echo esc_html(get_field('positive')['text_3']); ?></span></h4>
         <h4 style="display: flex;align-items: center;" class="px-lg-5 px-2 pt-4"><img src="<?php echo get_stylesheet_directory_uri() ?>/asset/img/check-mark-3.png" style="width: 25px;"><span class="px-2"><?php echo esc_html(get_field('positive')['text_4']); ?></span></h4>
         <h4 style="display: flex;align-items: center;" class="px-lg-5 px-2 pt-4"><img src="<?php echo get_stylesheet_directory_uri() ?>/asset/img/check-mark-3.png" style="width: 25px;"><span class="px-2"><?php echo esc_html(get_field('positive')['text_5']); ?></span></h4>
         <h4 style="display: flex;align-items: center;" class="px-lg-5 px-2 pt-4"><img src="<?php echo get_stylesheet_directory_uri() ?>/asset/img/check-mark-3.png" style="width: 25px;"><span class="px-2"><?php echo esc_html(get_field('positive')['text_6']); ?></span></h4>
         </div>
      </div>
      </div>
   </div>
...
<section id="services-section" class="services-area pt-50 pb-50">
   ...
   <div class="container">
      <p class="arrows my-lg-2 left animate" style="background-image: url('<?php echo get_stylesheet_directory_uri() ?>/asset/img/Vector-67.png');background-size: contain;"><?php echo esc_html(get_field('arrow')['text_1']); ?></p>
      <p class="arrows my-lg-2 right animate" style="background-image: url('<?php echo get_stylesheet_directory_uri() ?>/asset/img/Vector-69.png');background-size: contain;"><?php echo esc_html(get_field('arrow')['text_2']); ?></p>
      <p class="arrows my-lg-2 left animate" style="background-image: url('<?php echo get_stylesheet_directory_uri() ?>/asset/img/Vector-67.png');background-size: contain;"><?php echo esc_html(get_field('arrow')['text_3']); ?></p>
      <p class="arrows my-lg-2 right animate" style="background-image: url('<?php echo get_stylesheet_directory_uri() ?>/asset/img/Vector-69.png');background-size: contain;"><?php echo esc_html(get_field('arrow')['text_4']); ?></p>
      <p class="arrows my-lg-2 left animate" style="background-image: url('<?php echo get_stylesheet_directory_uri() ?>/asset/img/Vector-67.png');background-size: contain;"><?php echo esc_html(get_field('arrow')['text_5']); ?></p>
      <p class="arrows my-lg-2 right animate" style="background-image: url('<?php echo get_stylesheet_directory_uri() ?>/asset/img/Vector-69.png');background-size: contain;"><?php echo esc_html(get_field('arrow')['text_6']); ?></p>
   </div>
</section>
<hr>
<section class="services-area pt-50 pb-50">
