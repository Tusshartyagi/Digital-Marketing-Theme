...
<hr>
<section class="services-area pt-50 pb-50">
   <div class="container pb-3 px-3 mx-auto">
      <?php
   ...
   <div class="container">
      <div class="row choose-area pb-100 pt-100">
         <div class="col-md-12">
            ...
            <div class="container px-0 px-lg-2" style="z-index: 1;position: relative;">
             	<div class="row">
             		<div class="col-lg-6 col-md-12 d-flex pb-3 px-0 px-lg-2" style="flex-direction: row;flex-wrap: nowrap; align-items: flex-start;">
                              <img src="<?php echo get_stylesheet_directory_uri() ?>/asset/img/checkmark-3.png" style="width: 25px;">
             				  <div class="data mx-2" style="color:white"><h4 style="color:white"><?php echo esc_html(get_field('benifits')['title']); ?></h4>
                              <p><?php echo esc_html(get_field('benifits')['description']); ?></p>
							</div>
                   </div>
                   <div class="col-lg-6 col-md-12 d-flex pb-3 px-0 px-lg-2" style="flex-direction: row;flex-wrap: nowrap; align-items: flex-start;">
                              <img src="<?php echo get_stylesheet_directory_uri() ?>/asset/img/checkmark-3.png" style="width: 25px;">
                              <div class="data mx-2" style="color:white"><h4 style="color:white"><?php echo esc_html(get_field('benifits_1')['title']); ?></h4>
                              <p><?php echo esc_html(get_field('benifits_1')['description']); ?></p>
							</div>
                   </div>
                   <div class="col-lg-6 col-md-12 d-flex pt-3 px-0 px-lg-2" style="flex-direction: row;flex-wrap: nowrap; align-items: flex-start;">
                              <img src="<?php echo get_stylesheet_directory_uri() ?>/asset/img/checkmark-3.png" style="width: 25px;">
                              <div class="data mx-2" style="color:white"><h4 style="color:white"><?php echo esc_html(get_field('benifits_2')['title']); ?></h4>
                              <p><?php echo esc_html(get_field('benifits_2')['description']); ?></p>
							</div>
                   </div>
                   <div class="col-lg-6 col-md-12 d-flex pt-3 px-0 px-lg-2" style="flex-direction: row;flex-wrap: nowrap; align-items: flex-start;">
                              <img src="<?php echo get_stylesheet_directory_uri() ?>/asset/img/checkmark-3.png" style="width: 25px;">
                              <div class="data mx-2" style="color:white"><h4 style="color:white"><?php echo esc_html(get_field('benifits_3')['title']); ?></h4>
                              <p><?php echo esc_html(get_field('benifits_3')['description']); ?></p>
							</div>
                   </div>
                 </div>
              </div>                    
