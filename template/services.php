...
<hr>
<section class="services-area pt-50 pb-50">
   <div class="container pb-lg-5 px-lg-5 text-center mx-auto">
      <?php
   ...
   <div class="container-fluid py-lg-5 px-lg-5 mobile-responsive">
      <div class="row my-4">
         <div class="w-lg-75 boxes mx-auto pb-4 px-3 py-2" style="border-radius:30px 30px 5px 5px;flex-direction:column;height:260px">
            <p><?php echo esc_html(get_field('process')['title']); ?></p>
            <div style="color:black"><?php echo esc_html(get_field('process')['description']); ?></div>
         </div>
      </div>
      <div class="row my-4">
         <div class="w-lg-75 boxes-2 mx-auto pb-4 px-3 py-2" style="background-color:#FFC7C2;flex-direction:column;height:260px">
            <p style="color: #F24822;"><?php echo esc_html(get_field('process')['title_1']); ?></p>
            <div style="color:black"><?php echo esc_html(get_field('process')['description_1']); ?></div>
         </div>
      </div>
      <div class="row my-4">
         <div class="w-lg-75 boxes-2 mx-auto pb-4 px-3 py-2" style="background-color:#FCD19C;flex-direction:column;height:260px">
            <p style="color: #F8970F;"><?php echo esc_html(get_field('process')['title_2']); ?></p>
            <div style="color:black"><?php echo esc_html(get_field('process')['description_2']); ?></div>
         </div>
      </div>
      <div class="row my-4">
         <div class="w-lg-75 boxes-2 mx-auto pb-4 px-3 py-2" style="background-color:#AFF4C6;flex-direction:column;height:260px">
            <p style="color: #14AE5C;"><?php echo esc_html(get_field('process')['title_3']); ?></p>
            <div style="color:black"><?php echo esc_html(get_field('process')['description_3']); ?></div>
         </div>
      </div>
      <div class="row my-4">
         <div class="w-lg-75 boxes mx-auto pb-4 px-3 py-2" style="border-radius:5px 5px 30px 30px;flex-direction:column;height:280px">
            <p><?php echo esc_html(get_field('process')['title_4']); ?></p>
...
<section class="services-area pt-50 pb-50">
   <div class="container pb-3 px-lg-5 text-center mx-auto">
      ...
      ?>
      <h2 class="pb-3 text-center w-lg-75 mx-auto px-lg-5" style="line-height: 1.3em;color:#202020;font-size:36px"><?php echo esc_html($brand_title); ?></h2>
   </div>
...
<section class="services-area pt-50 pb-50">
   ...
   <div class="container-fluid py-0 px-lg-5 px-0">
      <div class="card-container row px-lg-5">
         <?php
         // Query to fetch posts from Services custom post type
         $args = array(
...
<section class="services-area pt-50 pb-50">
   ...
   <div class="container">
                        ...
                        $args = array(
                           ...
                           'tax_query' => array(
                              array(
                                 ...
                                 'field' => 'name',
                                 'terms' => 'Mobile Packages', // Term name
                              )
                           )
                        );
            ...
            <div class="row">
               <div class="col">
                  <div class="row">
                     ...
                     <div class="col">
                        <div class="package-amount text-right">$1599</div>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="row">
               <div class="col">
                  <div class="row">
                     ...
                     <div class="col">
                        <div class="package-amount text-right">$2999</div>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <div class="bg-background text-foreground rounded-lg desktop-responsive">
         <table class="w-full">
            <thead>
               <tr>
                  ...
                  <th class="px-4 py-5 border-bottom text-center">
                     <h4>Standard</h4><a href="<?php echo esc_html(get_field('url_2')); ?>" class="mx-2 btn btn-transparent border text-primary border-primary px-4 py-1">Get Started</a>
                  </th>
                  <th class="px-4 py-5 border-bottom text-center">
                     <h4>Business</h4><a href="<?php echo esc_html(get_field('url_3')); ?>" class="mx-2 btn btn-transparent border text-primary border-primary px-4 py-1">Get Started</a>
                  </th>
               </tr>
            </thead>
            <tbody>
               ...
               ?>
                     <tr>
                        ...
                        <td class="px-4 py-3 border-top text-center"><?php the_field('corporate'); ?></td>
                     </tr>
               <?php
                     $count++;
                  endwhile;
